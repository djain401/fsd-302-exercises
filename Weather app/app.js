...
const apiKey ="fd431883b967d5691ed21af378292126";
...
function celciusToFahrenheitToggle()
{
    ...
    console.log(temperatureFromApiCall);
        if(degreeUnit.textContent === 'F'){
            ...
            temperatureDegree.textContent = Math.floor(( temperatureFromApiCall - 273.15) * 9/5 + 32);
        ...
        if(navigator.geolocation)
        {
            document.getElementById('error-location').innerText = "";
             navigator.geolocation.getCurrentPosition((position) => {
                ...
                document.getElementById('error-location').innerText = "Please allow location access";
            })     
       }
    });
